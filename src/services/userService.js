...
export const updateAdminStatus = async (statusData) => {
  try {
    ...
    return { data: response.data, message: "Estado de admin actualizado. ✅" };
  } catch (error) {
...
export const recoverPassword = async ({ email, newPassword }) => {
  try {
    ...
    return { data: response.data, message: "Contraseña recuperada con éxito. ✅" };
  } catch (error) {
...
export const deleteUser = async () => {
  try {
    ...
    return { data: response.data, message: "Usuario eliminado con éxito. 🗑️" };
  } catch (error) {
...
export const deleteDirection = async (id_direccion) => {
  try {
    ...
    return { data: response.data, message: "Dirección eliminada con éxito. 🗑️" };
  } catch (error) {
